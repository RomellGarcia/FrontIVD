...
//Instancia base con configuración común
export const api = axios.create({
  baseURL: BASE,
  withCredentials: true
})

//Interceptor para agregar el token de Supabase automáticamente
api.interceptors.request.use((config) => {
  // El token lo guarda Supabase en localStorage
...
//Entrenadores (gestión admin/club)
